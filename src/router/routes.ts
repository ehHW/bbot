            ...
            // },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        component: () => import('@/views/Chat/components/MessageListPanel.vue'),
                        meta: {
                            title: '聊天室',
                            requiresAuth: true,
                            disableProgress: true,
                    ...
                    {
                        path: 'm/messages/detail',
                        name: 'ChatMessagesMobileDetail',
                        component: () => import('@/views/Chat/components/MessageWorkspace.vue'),
                        meta: {
                            title: '会话详情',
                            requiresAuth: true,
                            disableProgress: true,
                            mobileTab: 'messages',
                            mobileDetail: true,
                            mobileBackRouteName: 'ChatMessagesMobile',
                        },
                    },
                    {
                        path: 'm/contacts',
                        name: 'ChatContactsMobile',
                        component: () => import('@/views/Chat/components/ContactListPanel.vue'),
                        meta: {
                            title: '联系人',
                            requiresAuth: true,
                            disableProgress: true,
                    ...
                    {
                        path: 'm/contacts/friend-notices',
                        name: 'ChatContactsFriendNoticesMobile',
                        component: () => import('@/views/Chat/components/ContactFriendNoticesWorkspace.vue'),
                        meta: {
                            title: '好友通知',
                            requiresAuth: true,
                            disableProgress: true,
                            mobileTab: 'contacts',
                            mobileDetail: true,
                            mobileBackRouteName: 'ChatContactsMobile',
                        },
                    },
                    {
                        path: 'm/contacts/notices',
                        name: 'ChatContactsNoticesMobile',
                        component: () => import('@/views/Chat/components/ContactGroupNoticesWorkspace.vue'),
                        meta: {
                            title: '群通知',
                            requiresAuth: true,
                            disableProgress: true,
                    ...
                    {
                        path: 'm/settings',
                        name: 'ChatSettingsMobile',
                        component: () => import('@/views/Chat/components/ChatSettingsPanel.vue'),
                        meta: {
                            title: '设置',
                            requiresAuth: true,
                            disableProgress: true,
                    ...
                    {
                        path: 'm/settings/shortcuts',
                        name: 'ChatSettingsShortcutsMobile',
                        component: () => import('@/views/Chat/components/ChatShortcutSettingsWorkspace.vue'),
                        meta: {
                            title: '快捷键',
                            requiresAuth: true,
                            disableProgress: true,
                    ...
                    {
                        path: 'm/settings/inspect',
                        name: 'ChatSettingsInspectMobile',
                        component: () => import('@/views/Chat/components/ChatInspectSettingsWorkspace.vue'),
                        meta: {
                            title: '巡检模式',
                            requiresAuth: true,
                            disableProgress: true,
